seqfile = {phy_fn} * sequence data filename (phylip alignment)
outfile = {out_dir}/{phy}.{mod}.out * main result file name 
treefile = {species_tree_fn} * tree structure file name (newick format)
